...
const { emails: { registered: registeredEmail } } = require('../../../lib/sendgrid/config');
...
export default async (req, res) => {
    ...
    switch (method) {
        case 'POST': {
            const { email, username, password, captcha, ip } = req?.body;
        ...
        case 'DELETE': {
            const { email, captcha, code, ip } = req?.body;

...
const { validateCaptcha, generateRandomNumber, seperateNumber, logError, hashPassword } = require('../../../lib/functions');
...
const { emails: { forgotPassword: forgotPasswordEmail } } = require('../../../lib/sendgrid/config');
